...
var Modal = _react2.default.createClass({
  ...
  propTypes: {
    ...
    actionsMulti: _react2.default.PropTypes.bool,
  ...
  handleBackdropClick: function handleBackdropClick(e) {
    var selfNode = _reactDom2.default.findDOMNode(this.refs.backdrop);
  ...
  renderActions: function renderActions(classSet) {
    ...
    var actionsMulti = this.props.actionsMulti;
        ...
        buttons = [cancelText, confirmText].map(function (text, i) {
          return _react2.default.createElement(
            _RcHammer2.default,
            {
              component: 'span',
              key: 'modalBtn' + i,
              onTap: _this.handleSelect.bind(_this, i === 0 ? cancel : true),
              className: btnClass
            },
            text
          );
  ...
  renderBackdrop: function renderBackdrop(children) {
    ...
    return _react2.default.createElement(
      ...
      null,
      children,
      _react2.default.createElement(_RcHammer2.default, {
