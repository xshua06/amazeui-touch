...
var Notification = _react2.default.createClass({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(newProps) {
    ...
    this.setState({ message: message, visible: visible });
    this.loopPlay(newProps);
  },
  loopPlay: function loopPlay(props) {
    var _this = this;
    _this.last = false;
    ...
    // 获取第一条信息
    var duration = props ? props.duration : this.props.duration;
    var message = (props ? props.message : this.state.message).slice();
    ...
    if (msgLen > 0) {
      ...
      this.setState({ index: index, message: message, msg: msg });
  ...
  render: function render() {
    ...
    var anim = _react2.default.createElement(
      ...
      {
        component: 'div',
        className: (0, _classnames2.default)({ "notification-loop": visible && msgLen > 0, "notification-single": !visible || msgLen == 0 }),
