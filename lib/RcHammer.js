...
var RcHammer = function (_Component) {
  ...
  _createClass(RcHammer, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props3, ['component', 'className', 'children', 'onActive', 'onDisabled', 'onAfterHandle', 'onBeforeHandle', 'role']);
      ...
      props.className = (0, _classnames2.default)(className, { disabled: disabled, actived: actived && !active, active: !disabled && active });
